  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: const [
          Text(
            'Iniciar sesión en TGD y continuar',
          ...
          Text(
            'Introduce tu correo electrónico y contraseña para continuar en CRG y ¡que empiece el portal!',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: Colors.white,
              fontSize: 15,
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            ...
            child: Row(
              ...
              children: [
                Image.asset(
                  'assets/images/google.png', // Ruta de la imagen SVG del ícono de Google
    ...
    return Container(
      decoration: const BoxDecoration(
          gradient: LinearGradient(
              colors: [Color.fromARGB(255, 0, 255, 64), Color.fromARGB(255, 3, 67, 119)],
